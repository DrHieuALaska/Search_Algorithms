...
def hill_climbing_multi_starts_with_evals(
    objective_function,
    DIMENSION,
    BOUNDS,
    N_STARTS=20,
...
# -----------------------------------------------
def Hill_climbing_multi_starts_run_trials_multi_func_to_csv(FUNCTIONS_FOR_HILL_CLIMBING, folder_path, file_name, n_trials=30):
    all_rows = []
    for fn_cfg in FUNCTIONS_FOR_HILL_CLIMBING:
        ...
        all_rows.extend(run_trials(fn_cfg["name"], hill_climbing_multi_starts_with_evals, kwargs, n_trials=n_trials))
