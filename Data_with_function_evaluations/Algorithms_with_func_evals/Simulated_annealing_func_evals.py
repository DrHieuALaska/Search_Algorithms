...
def multi_start_simulated_annealing_with_evals(
    objective_function,
    DIMENSION,
    BOUNDS,
    N_STARTS=10,
...
# -----------------------------------------------
def Simulated_annealing_run_trials_multi_func_to_csv(FUNCTIONS_FOR_SIMULATED_ANNEALING, folder_path, file_name, n_trials=30):
    all_rows = []
    for fn_cfg in FUNCTIONS_FOR_SIMULATED_ANNEALING:
        ...
        all_rows.extend(run_trials(fn_cfg["name"], multi_start_simulated_annealing_with_evals, kwargs, n_trials=n_trials))
